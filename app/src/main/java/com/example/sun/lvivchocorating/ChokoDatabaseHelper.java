...
public class ChokoDatabaseHelper extends SQLiteOpenHelper {


    private static final String DB_NAME = "lvivchoko";
    private static final int DB_VERSION = 1;


    public ChokoDatabaseHelper(Context context) {
    ...
    private void updateMyDatabase(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (oldVersion < 2) {
            db.execSQL("ALTER TABLE CANDY ADD COLUMN RATING NUMERIC;");
        }
    }
    ...
    private static void insertDrink(SQLiteDatabase db, String name,
        ...
        db.insert("DRINK", null, candyValues);
    }
}
